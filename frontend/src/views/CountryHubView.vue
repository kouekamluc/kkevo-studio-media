  ...
  <div class="min-h-screen py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
      ...
      <template v-else-if="country">
        ...
        <div class="bg-kkevo-navy-900 border border-kkevo-navy-800 rounded-lg p-6 sm:p-8 space-y-6">
          ...
          <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 text-xs">
            <div class="p-3 bg-kkevo-navy-950 rounded border border-kkevo-navy-800">
              <span class="text-slate-400 block font-mono text-[11px]">Nominal GDP</span>
              <span class="text-base font-bold text-white font-mono">{{ country.gdp_nominal_usd || 'N/A' }}</span>
            </div>
            <div class="p-3 bg-kkevo-navy-950 rounded border border-kkevo-navy-800">
              <span class="text-slate-400 block font-mono text-[11px]">Population</span>
              <span class="text-base font-bold text-white font-mono">{{ country.population || 'N/A' }}</span>
            </div>
            <div class="p-3 bg-kkevo-navy-950 rounded border border-kkevo-navy-800 col-span-2">
              <span class="text-slate-400 block font-mono text-[11px]">Primary Strategic Resources</span>
              <div class="flex flex-wrap gap-1.5 mt-1">
                <span
                  v-for="res in country.strategic_resources"
                  :key="res"
                  class="px-2 py-0.5 rounded bg-kkevo-navy-900 text-slate-200 text-[11px] font-semibold border border-slate-700"
                >
                  {{ res }}
                </span>
              </div>
          ...
          <div v-if="country.sovereignty_notes" class="p-4 bg-blue-950/40 border-l-4 border-kkevo-blue rounded-r text-xs text-slate-300 leading-relaxed">
            <span class="font-bold text-kkevo-blue-glow block mb-1 font-mono uppercase text-[11px]">
